...
namespace ZeroX.FolderShortcut
{
    ...
    {
        public const string ROOT_FOLDER = "Assets/ZeroX/Core/Editor/Folder Shortcut/";
        ...
        public static Texture UpArrowIcon
        {
            get
            {
                if (m_upArrowIcon == null)
                    m_upArrowIcon = AssetDatabase.LoadAssetAtPath<Texture>(ROOT_FOLDER + "Icon/up arrow.png");
        ...
        public static Texture DownArrowIcon
        {
            get
            {
                if (m_downArrowIcon == null)
                    m_downArrowIcon = AssetDatabase.LoadAssetAtPath<Texture>(ROOT_FOLDER + "Icon/down arrow.png");
        ...
        public static Texture RightArrowIcon
        {
            get
            {
                if (m_rightArrowIcon == null)
                    m_rightArrowIcon = AssetDatabase.LoadAssetAtPath<Texture>(ROOT_FOLDER + "Icon/right arrow.png");
        ...
        public static Texture UpArrowOrderIcon
        {
            get
            {
                if (m_upArrowOrderIcon == null)
                    m_upArrowOrderIcon = AssetDatabase.LoadAssetAtPath<Texture>(ROOT_FOLDER + "Icon/up arrow order.png");
        ...
        public static Texture DownArrowOrderIcon
        {
            get
            {
                if (m_downArrowOrderIcon == null)
                    m_downArrowOrderIcon = AssetDatabase.LoadAssetAtPath<Texture>(ROOT_FOLDER + "Icon/down arrow order.png");
